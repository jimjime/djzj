             ...
             <div class="row">
                ...
                <tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><tr class="">
							<td><?php echo ($i); ?></td>
							<td><?php echo ($l["user_invite_channelId"]); ?></td>
							<td><?php echo ($l["name"]); ?></td>
							<td><img src="<?php echo ($l["qr_img"]); ?>" width="100" style="border:1px solid #eee;" /></td>
							<td><?php echo ($l["user_count"]); ?></td>
							<td>
								<a class="tan_edit" data-toggle="modal" href="#bianjibox<?php echo ($l["user_invite_channelId"]); ?>">编辑</a>
							</td>
							<!--编辑框 start-->
							<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="bianjibox<?php echo ($l["user_invite_channelId"]); ?>" class="modal fade">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body ">
											<form action="<?php echo U('Inchannel/invite_channel_edit');?>" method="post">
												<input type="hidden" name="id" value="<?php echo ($l["user_invite_channelId"]); ?>">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form role="form" action="<?php echo U('Inchannel/invite_channel_edit');?>" method="post" >
