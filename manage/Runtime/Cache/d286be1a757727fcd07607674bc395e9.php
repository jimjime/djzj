        ...
        <div class="wrapper">
			...
			<div class="row">
                ...
                <header class="panel-heading">
                    <a href="<?php echo U('Exchange/exchange',array(txstate=>1));?>" style="color:#65CEA7;">未处理</a>
                    <a href="<?php echo U('Exchange/exchange',array(txstate=>2));?>" style="color:#666;">已处理</a>
<!--                    <a href="<?php echo U('Exchange/yxcdojiesuan');?>" style="color:#666;">英雄猜结算</a>
                    <a href="<?php echo U('Exchange/yxcpeilvjisuan');?>" style="color:#666;">英雄猜赔率计算</a>
-->                    <!--<span class="tools pull-right">
                ...
                <tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><tr class="">
							...
							<td><?php echo ($l["user"]["tel"]); ?></td>
							<td><?php echo ($l["user"]["alipay"]); ?></td>
							<td><?php echo ($l["detail"]); ?></td>
							<td>
								<?php if($l['txstate']==1){ ?>
									<a href="<?php echo U('Exchange/exchange_change',array(id=>$l[user_golds_recordId]));?>">标记为已处理</a>
								<?php }else{ ?>
									已处理
								<?php } ?>
							</td>
