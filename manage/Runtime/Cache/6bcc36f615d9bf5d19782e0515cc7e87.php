             ...
             <div class="row">
                ...
                <tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><tr class="">
							<td><?php echo ($i); ?></td>
							<td><?php echo ($l["game_typeId"]); ?></td>
							<td><?php echo ($l["cnName"]); ?></td>
							<td><?php echo ($l["enName"]); ?></td>
							<td>
								<a class="tan_edit" data-toggle="modal" href="#bianjibox<?php echo ($l["game_typeId"]); ?>">编辑</a>
								|
								<?php if($l['state']==1){ ?>
									<a href="javascript:;" onclick="del_admin(<?php echo ($l["game_typeId"]); ?>,'game_type',this,'game_typeId')">删除</a>
								<?php }else{ ?>
									<a href="javascript:;" onclick="hui_admin(<?php echo ($l["game_typeId"]); ?>,'game_type',this,'game_typeId')">恢复</a>
									|
									<a href="javascript:;" class="cddel_admin_btn" onclick="cddel_admin(<?php echo ($l["game_typeId"]); ?>,'game_type',this,'game_typeId')">彻底删除</a>
								<?php } ?>
							</td>
							<!--编辑框 start-->
							<div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="bianjibox<?php echo ($l["game_typeId"]); ?>" class="modal fade">
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body ">
											<form action="<?php echo U('Tupian/game_type_edit');?>" method="post">
												<input type="hidden" name="id" value="<?php echo ($l["game_typeId"]); ?>">
												<div class="form-group">
													<label>中文名称：</label>
													<input id="name" name="cnName" value="<?php echo ($l["cnName"]); ?>" class="form-control">
												</div>
												<div class="form-group">
													<label>英文名称：</label>
													<input id="name" name="enName" value="<?php echo ($l["enName"]); ?>" class="form-control">
												</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form role="form" action="<?php echo U('Tupian/game_type_edit');?>" method="post" >
							<input type="hidden" name="id" value="">
							<div class="form-group">
								<label>中文名称：</label>
								<input id="name" name="cnName" value="" class="form-control">
							</div>
							<div class="form-group">
								<label>英文名称：</label>
								<input id="name" name="enName" value="" class="form-control">
							</div>
							<button type="submit" class="btn btn-primary">保存</button>
						</form>
					</div>
