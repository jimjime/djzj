                ...
                <tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><tr class="">
							...
							<td>
								...
								|
								<?php if($l['state']==1){ ?>
									<a href="javascript:;" onclick="del_admin(<?php echo ($l["id"]); ?>,'game_cstate',this,'id')">删除</a>
								<?php }else{ ?>
									<a href="javascript:;" onclick="hui_admin(<?php echo ($l["id"]); ?>,'game_cstate',this,'id')">恢复</a>
									|
									<a href="javascript:;" class="cddel_admin_btn" onclick="cddel_admin(<?php echo ($l["id"]); ?>,'game_cstate',this,'id')">彻底删除</a>
								<?php } ?>
							</td>
						</tr>
						<!--编辑框 start-->
							...
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body ">
										<form action="<?php echo U('Games/game_cstate_edit');?>" method="post">
