             ...
             <div class="row">
                ...
                <tbody>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$l): $mod = ($i % 2 );++$i;?><tr class="">
							<td><?php echo ($i); ?></td>
							<td><?php echo ($l["id"]); ?></td>
							<td><?php echo ($l["dayday"]); ?></td>
							<td><?php echo ($l["shifen"]); ?></td>
							<td><?php echo ($l["xiangmuname"]); ?></td>
							<td><?php echo ($l["quname"]); ?></td>
							<td><?php echo ($l["jibie"]); ?></td>
							<td>
								<?php if($l['team1']<=0){ ?>
								<?php echo ($l["user1info"]["soloname"]); ?><br>
								<img src="<?php echo ($l["user1info"]["solologo"]); ?>" height="40" style="border-radius: 50%;" />
								<?php }else{ ?>
								<?php echo ($l["team1info"]["name"]); ?><br>
								<img src="<?php echo ($l["team1info"]["logo"]); ?>" height="40" style="border-radius: 50%;" />
								<?php } ?>
							</td>
							<td>
								<?php if($l['team2']<=0){ ?>
								<?php echo ($l["user2info"]["soloname"]); ?><br>
								<img src="<?php echo ($l["user2info"]["solologo"]); ?>" height="40" style="border-radius: 50%;" />
								<?php }else{ ?>
								<?php echo ($l["team2info"]["name"]); ?><br>
								<img src="<?php echo ($l["team2info"]["logo"]); ?>" height="40" style="border-radius: 50%;" />
								<?php } ?>
							</td>
							<td><?php echo ($l["didian"]); ?></td>
							<td><?php echo ($l["jieguo"]); ?></td>
							<td><?php echo ($l["xu"]); ?></td>
							<td>
								<a class="tan_edit" data-toggle="modal" href="#bianjibox<?php echo ($l["id"]); ?>">编辑</a>
								|
								<a href="javascript:;" class="cddel_admin_btn" onclick="cddel_admin(<?php echo ($l["id"]); ?>,'bs_saicheng',this,'id')">彻底删除</a>
							</td>
							<!--编辑框 start-->
								...
								<div class="modal-dialog">
									<div class="modal-content">
										...
										<div class="modal-body ">
											<form enctype="multipart/form-data" action="<?php echo U('Saishi/bs_saicheng_edit');?>" method="post">
												<input type="hidden" name="id" value="<?php echo ($l["id"]); ?>">
												<div class="form-group">
													<label>日期：</label>
													<select name="day" class="form-control">
														<?php if(is_array($days)): $ii = 0; $__LIST__ = $days;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($ii % 2 );++$ii;?><option value="<?php echo ($d["id"]); ?>"  <?php if($d['id']==$l['day']){ ?>selected="selected"<?php } ?>><?php echo ($d["day"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
													</select>
												</div>
												<div class="form-group">
													<label>时分：</label>
													<input name="shifen" value="<?php echo ($l["shifen"]); ?>" class="form-control">
												</div>
												<div class="form-group">
													<label>比赛项目：</label>
													<select name="xiangmu" class="form-control" id="xiangmu">
														<?php if(is_array($xiangmus)): $ii = 0; $__LIST__ = $xiangmus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($ii % 2 );++$ii;?><option value="<?php echo ($d["id"]); ?>"  <?php if($d['id']==$l['xiangmu']){ ?>selected="selected"<?php } ?>><?php echo ($d["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
													</select>
												</div>
												<div class="form-group">
													<label>赛区：</label>
													<select name="qu" class="form-control">
														<?php if(is_array($qus)): $ii = 0; $__LIST__ = $qus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($ii % 2 );++$ii;?><option value="<?php echo ($d["id"]); ?>"  <?php if($d['id']==$l['qu']){ ?>selected="selected"<?php } ?>><?php echo ($d["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
													</select>
												</div>
												<div class="form-group">
													<label>级别：</label>
													<input name="jibie" value="<?php echo ($l["jibie"]); ?>" class="form-control">
												</div>
												<div class="form-group teamselect">
													<label>队伍1：</label>
													<select name="team1" class="form-control">
														<option value="0">请选择</option>
														<?php if(is_array($teams)): $ii = 0; $__LIST__ = $teams;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($ii % 2 );++$ii;?><option value="<?php echo ($d["id"]); ?>"  <?php if($d['id']==$l['team1']){ ?>selected="selected"<?php } ?>><?php echo ($d["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
													</select>
												</div>
												<div class="form-group teamselect">
													<label>队伍2：</label>
													<select name="team2" class="form-control">
														<option value="0">请选择</option>
														<?php if(is_array($teams)): $ii = 0; $__LIST__ = $teams;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($ii % 2 );++$ii;?><option value="<?php echo ($d["id"]); ?>"  <?php if($d['id']==$l['team2']){ ?>selected="selected"<?php } ?>><?php echo ($d["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
													</select>
												</div>
												<div class="form-group userselect">
													...
													<select name="user1" class="form-control">
														<option value="0">请选择</option>
														<?php if(is_array($users)): $ii = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($ii % 2 );++$ii;?><option value="<?php echo ($d["uid"]); ?>"  <?php if($d['uid']==$l['user1']){ ?>selected="selected"<?php } ?>><?php echo ($d["soloname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
													</select>
												</div>
												<div class="form-group userselect">
													<label>选手2：</label>
													<select name="user2" class="form-control">
														<option value="0">请选择</option>
														<?php if(is_array($users)): $ii = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($ii % 2 );++$ii;?><option value="<?php echo ($d["uid"]); ?>"  <?php if($d['uid']==$l['user2']){ ?>selected="selected"<?php } ?>><?php echo ($d["soloname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
													</select>
												</div>
												<div class="form-group">
													<label>比赛地点：</label>
													<input name="didian" value="<?php echo ($l["didian"]); ?>" class="form-control">
												</div>
												<div class="form-group">
													<label>比赛结果：</label>
													<input name="jieguo" value="<?php echo ($l["jieguo"]); ?>" class="form-control">
												</div>
												<div class="form-group">
													<label>排序：</label>
													<input name="xu" value="<?php echo ($l["xu"]); ?>" class="form-control">
												</div>
					...
					<div class="modal-body">
						...
						<form enctype="multipart/form-data" action="<?php echo U('Saishi/bs_saicheng_edit');?>" method="post">
							...
							<div class="form-group">
								<label>日期：</label>
								<select name="day" class="form-control">
									<?php if(is_array($days)): $ii = 0; $__LIST__ = $days;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($ii % 2 );++$ii;?><option value="<?php echo ($d["id"]); ?>"><?php echo ($d["day"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
							<div class="form-group">
								<label>时分：</label>
							...
							<div class="form-group">
								<label>比赛项目：</label>
								<select name="xiangmu" class="form-control" id="xiangmu">
									<?php if(is_array($xiangmus)): $ii = 0; $__LIST__ = $xiangmus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($ii % 2 );++$ii;?><option value="<?php echo ($d["id"]); ?>"><?php echo ($d["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
							<div class="form-group">
								<label>赛区：</label>
								<select name="qu" class="form-control">
									<?php if(is_array($qus)): $ii = 0; $__LIST__ = $qus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($ii % 2 );++$ii;?><option value="<?php echo ($d["id"]); ?>"><?php echo ($d["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
							<div class="form-group">
								<label>级别：</label>
							...
							<div class="form-group teamselect">
								...
								<select name="team1" class="form-control">
									<option value="0">请选择</option>
									<?php if(is_array($teams)): $ii = 0; $__LIST__ = $teams;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($ii % 2 );++$ii;?><option value="<?php echo ($d["id"]); ?>"><?php echo ($d["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
							<div class="form-group teamselect">
								<label>队伍2：</label>
							...
							<div class="form-group userselect">
								...
								<select name="user1" class="form-control">
									<option value="0">请选择</option>
									<?php if(is_array($users)): $ii = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$d): $mod = ($ii % 2 );++$ii;?><option value="<?php echo ($d["uid"]); ?>"><?php echo ($d["soloname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
							<div class="form-group userselect">
								<label>选手2：</label>
